...
public class MusicService extends Service {
    ...
    public void MusicPlay(int musicId){
        switch (musicId){
            case 0:
                player = MediaPlayer.create(this,R.raw.music00);
                break;
            case 1:
                player = MediaPlayer.create(this,R.raw.music01);
                break;
            case 2:
                player = MediaPlayer.create(this,R.raw.music02);
                break;
            case 3:
                player = MediaPlayer.create(this,R.raw.music03);
                break;
            case 4:
                player = MediaPlayer.create(this,R.raw.music04);
                break;
        }
    }
